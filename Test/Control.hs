...
builddeps :: Relations
builddeps = [[RRel (BinPkgName {unBinPkgName = "debhelper"}) (Just (GRE (Debian.Version.parseDebianVersion' ("7" :: String)))) Nothing []],
             [RRel (BinPkgName {unBinPkgName = "cdbs"}) Nothing Nothing []],
             [RRel (BinPkgName {unBinPkgName = "haskell-devscripts"}) (Just (GRE (Debian.Version.parseDebianVersion' ("0.7" :: String)))) Nothing []],
             [RRel (BinPkgName {unBinPkgName = "ghc"}) Nothing Nothing []],
             [RRel (BinPkgName {unBinPkgName = "ghc-prof"}) Nothing Nothing []],
             [RRel (BinPkgName {unBinPkgName = "libghc-hunit-dev"}) Nothing Nothing []],
             [RRel (BinPkgName {unBinPkgName = "libghc-hunit-prof"}) Nothing Nothing []],
             [RRel (BinPkgName {unBinPkgName = "libghc-mtl-dev"}) Nothing Nothing []],
             [RRel (BinPkgName {unBinPkgName = "libghc-mtl-prof"}) Nothing Nothing []],
             [RRel (BinPkgName {unBinPkgName = "libghc-parsec3-dev"}) Nothing Nothing []],
             [RRel (BinPkgName {unBinPkgName = "libghc-parsec3-prof"}) Nothing Nothing []],
             [RRel (BinPkgName {unBinPkgName = "libghc-pretty-class-dev"}) Nothing Nothing []],
             [RRel (BinPkgName {unBinPkgName = "libghc-pretty-class-prof"}) Nothing Nothing []],
             [RRel (BinPkgName {unBinPkgName = "libghc-process-extras-dev"}) (Just (GRE (Debian.Version.parseDebianVersion' ("0.4" :: String)))) Nothing []],
             [RRel (BinPkgName {unBinPkgName = "libghc-process-extras-prof"}) (Just (GRE (Debian.Version.parseDebianVersion' ("0.4" :: String)))) Nothing []],
             [RRel (BinPkgName {unBinPkgName = "libghc-regex-compat-dev"}) Nothing Nothing []],
             [RRel (BinPkgName {unBinPkgName = "libghc-regex-compat-prof"}) Nothing Nothing []],
             [RRel (BinPkgName {unBinPkgName = "libghc-regex-tdfa-dev"}) (Just (GRE (Debian.Version.parseDebianVersion' ("1.1.3" :: String)))) Nothing []],
             [RRel (BinPkgName {unBinPkgName = "libghc-regex-tdfa-prof"}) Nothing Nothing []],
             [RRel (BinPkgName {unBinPkgName = "libghc-bzlib-dev"}) (Just (GRE (Debian.Version.parseDebianVersion' ("0.5.0.0-4" :: String)))) Nothing []],
             [RRel (BinPkgName {unBinPkgName = "libghc-bzlib-prof"}) Nothing Nothing []],
             [RRel (BinPkgName {unBinPkgName = "libghc-haxml-prof"}) (Just (GRE (Debian.Version.parseDebianVersion' ("1:1.20" :: String)))) Nothing []],
             ...
             [RRel (BinPkgName {unBinPkgName = "libghc-zlib-dev"}) Nothing Nothing []],
             [RRel (BinPkgName {unBinPkgName = "libghc-zlib-prof"}) Nothing Nothing []],
             [RRel (BinPkgName {unBinPkgName = "libghc-network-dev"}) (Just (GRE (Debian.Version.parseDebianVersion' ("2.4" :: String)))) Nothing []],
             [RRel (BinPkgName {unBinPkgName = "libghc-network-prof"}) (Just (GRE (Debian.Version.parseDebianVersion' ("2.4" :: String)))) Nothing []],
             [RRel (BinPkgName {unBinPkgName = "libghc-utf8-string-dev"}) Nothing Nothing []],
             [RRel (BinPkgName {unBinPkgName = "libghc-utf8-string-prof"}) Nothing Nothing []],
             [RRel (BinPkgName {unBinPkgName = "libcrypto++-dev"}) Nothing Nothing []],
             [RRel (BinPkgName {unBinPkgName = "libghc-faketestdependency-dev"}) Nothing Nothing [MO.fromList [("nocheck", False), ("two", True), ("three", False)], MO.fromList [("four", True), ("five", False), ("six", True)]]]
             ]
